        ...
        return (
          <div className="space-y-3">
            ...
            {updateStatus.releaseNotes && (
              <div className="text-sm text-slate-400 bg-white/5 rounded-lg p-3 max-h-32 overflow-y-auto">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-medium hover:from-emerald-400 hover:to-emerald-500 transition-all disabled:opacity-50"
            >
        ...
        return (
          <div className="space-y-3">
            ...
            <div className="w-full bg-white/10 rounded-full h-2">
              <div 
                className="bg-gradient-to-r from-wp-blue-500 to-wp-blue-400 h-2 rounded-full transition-all duration-300"
        ...
        return (
          <div className="space-y-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-medium hover:from-emerald-400 hover:to-emerald-500 transition-all"
            >
      ...
      case 'error':
        return (
          <div className="space-y-3">
            ...
            {updateStatus.error && (
              <p className="text-sm text-slate-500">{updateStatus.error}</p>
            )}
          </div>
        )
...
export function UpdateBadge() {
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-xs font-medium animate-pulse">
